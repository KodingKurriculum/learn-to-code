...
"""
2.) Variables are created using the keyword var.  Hello World is called a String.
Strings are denoted by single or double quotes and represent a
...
"""
3.) The print() function is a part of the standard Python library, and prints
